...
export default function ShowPartnerships() {
  ...
  useEffect(() => {
    async function fetchData() {
      const [res, err] = await queryApi("partnerships")
      setError(err)
      setPartnerships(res)
    }
    fetchData()
  ...
  }, [state, partnerships, order])

  function handleAddRedirect() {
    history.push("/partnership/add")
  }
              ...
              <Form action="" method="post" className="form-horizontal" onSubmit={handleSubmit}>
                <FormGroup row>
                  ...
                  <Col md="4" sm="4">
                    <InputGroup className="mt-2">
                      <InputGroupAddon addonType="prepend">
                        <Button color="primary">Type de partenaire:</Button>
                      </InputGroupAddon>
                ...
                {(currentUser.roles.includes("createPartnership") || currentUser.roles.includes("admin")) && (
                  <FormGroup row>
                    <Col md="4" sm="4">
                      <InputGroup className="mt-2">
            ...
            <CardBody>
              ...
              <Row>
                ...
                {filtered && filtered?.length === 0 && (
                  <Col md="4" sm="4">
                    <Alert color="warning">Pas de partenaire trouvés.</Alert>
                  </Col>
                )}
              </Row>
            </CardBody>
