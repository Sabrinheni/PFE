...
export default function AddEspritIngenieur() {
  ...
  async function handleSubmit(e) {
    ...
    setShowLoader(true)
    const [, err] = await queryApi("EspritIngenieur", form, "POST", true)
    if (err) {
      setShowLoader(false)
      setError({
        visible: true,
  ...
  return (
    <Card>
      <CardHeader>
        <strong>Esprit Ingenieur : </strong> Ajouter
      </CardHeader>
      <CardBody>
        {error.visible && (
        ...
        <AvForm onValidSubmit={handleSubmit}>
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              ...
              <FormText color="muted">Titre du Esprit Ingenieur à ajouter</FormText>
            </Col>
          </FormGroup>
